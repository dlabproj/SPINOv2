...
from external.ms_deformable_attention.functions import MSDeformAttnFunction
...
class MSDeformAttn(nn.Module):
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes,
        ...
        :param reference_points             (N, Length_{query}, n_levels, 2), range in [0, 1],
                                            ...
                                            including padding area or (N, Length_{query},
                                            n_levels, 4), add additional (w, h) to form
                                            reference boxes
